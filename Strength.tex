...
% The following establishes the notation

In the standard analysis, precautionary saving is modelled as the outcome of a consumer's optimizing choice of
how to allocate existing resources between the present and the future.  % CDC 2007-04-08 , originally formulated 
...
% When the relative risk aversion of the value function is constant, $\varepsilon = 1$ and ${\cal P} = (1 + \varsigma)\rho.$
